(function ($, Drupal, drupalSettings) {
  Drupal.behaviors.budgetIncomesChart = {
    attach: function (context, settings) {
     ...
     /*if (settings.budgetIncomesData) {

       console.log(settings.budgetIncomesData);
       Higharts.chart('budget-incomes-chart', {
         chart: { type: 'column' },
         title: { text: 'Доходы бюджета' },
         series: [{
           name: 'Млн руб.',
           data: settings.budgetIncomesData
         }]
       });
     }*/
